    ...
    carriers: {
        ...
        usps: {
            ...
            services: [
                ...
                { code: 'PRIORITY_MAIL_EXPRESS', label: 'USPS Priority Mail Express', enabled: true, domesticOnly: true },
        ...
        ups: {
            ...
            services: [
                ...
                { code: 'UPS_2ND_DAY_AIR', label: 'UPS 2-day', enabled: true, domesticOnly: true },
            ]
        },
        ups_f: {
            enabled: true,
        ...
        ups_one_rate: {
            ...
            services: [
                ...
                { code: 'UPS_ONE_RATE_2ND_DAY_AIR', label: 'UPS One Rate 2-Day Air', enabled: true, domesticOnly: true },
                { code: 'UPS_ONE_RATE_NEXT_DAY_AIR_SAVER', label: 'UPS One Rate Next Day Air Saver', enabled: true, domesticOnly: true },
                { code: 'UPS_ONE_RATE_NEXT_DAY_AIR', label: 'UPS One Rate Next Day Air', enabled: true, domesticOnly: true },
            ]
        },
        dhl_ecomm: {
            enabled: true,
            services: [
                { code: 'DHLeCommerceParcelExpedited', label: 'DHL eCommerce Parcel Expedited', enabled: true, domesticOnly: true },
                { code: 'DHLeCommerceParcelExpeditedMax', label: 'DHL eCommerce Parcel Expedited Max', enabled: true, domesticOnly: true },
                { code: 'DHLeCommerceParcelGround', label: 'DHL eCommerce Parcel Ground', enabled: true, domesticOnly: true },
                { code: 'DHLeCommerceParcelPlus', label: 'DHL eCommerce Parcel Plus Expedited', enabled: true, domesticOnly: true },
                { code: 'DHLeCommerceBPMExpedited', label: 'DHL eCommerce BPM Expedited', enabled: true, domesticOnly: true },
        ...
        dhl_express: {
            enabled: true,
            services: [
                { code: 'DHLExpressExpressWorldwide', label: 'DHL Express Worldwide', enabled: true, internationalOnly: true },
                { code: 'DHLExpressExpressMidpointDelivery', label: 'DHL Express Midpoint Delivery', enabled: true, internationalOnly: true },
                { code: 'DHLExpressExpressEasyNDX', label: 'DHL Express Easy', enabled: true, internationalOnly: true },
                { code: 'DHLExpressWorldwideNDX', label: 'DHL Express Worldwide NDX', enabled: true, internationalOnly: true },
            ]
        },
        fedex_wallet: {
            enabled: true,
            services: [
                ...
                { code: 'FEDEX_2_DAY', label: 'FedEx 2Day (Wallet)', enabled: true, domesticOnly: true },
                { code: 'PRIORITY_OVERNIGHT', label: 'FedEx Priority Overnight (Wallet)', enabled: true, domesticOnly: true },
                { code: 'INTERNATIONAL_PRIORITY', label: 'FedEx International Priority Express (Wallet)', enabled: true, internationalOnly: true },
                { code: 'INTERNATIONAL_ECONOMY', label: 'FedEx International Economy Express (Wallet)', enabled: true, internationalOnly: true },
            ]
        },
        asendia: {
            enabled: true,
